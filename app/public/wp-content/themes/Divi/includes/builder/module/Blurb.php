...
class ET_Builder_Module_Blurb extends ET_Builder_Module {
	...
	public function get_transition_fields_css_props() {
		...
		$fields['content_max_width'] = array(
			'max-width' => '%%order_class%% .et_pb_blurb_container',
		);
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		// Hover content.
		$content_max_width_selector = '%%order_class%% .et_pb_blurb_container';
		...
		if ( '' !== $content_max_width_tablet || '' !== $content_max_width_phone || '' !== $content_max_width ) {
			...
			et_pb_responsive_options()->generate_responsive_css( $content_max_width_values, '%%order_class%% .et_pb_blurb_container', 'max-width', $render_slug );
